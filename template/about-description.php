            ...
            <div class="card h-100 border-0 shadow-sm p-3">
                <div class="card-body">
                    <div class="text-unibo mb-3">
                        <i class="bi bi-chat-quote-fill display-4"></i>
                    </div>
                    <h3 class="h5 fw-bold">Libertà di Parola</h3>
                    <p class="text-muted">
        ...
        <div class="col-md-4">
            <div class="card h-100 border-0 shadow-sm p-3">
                <div class="card-body">
                    ...
                    <h3 class="h5 fw-bold">Anonimato Sicuro</h3>
                    <p class="text-muted">
        ...
        <div class="col-md-4">
            <div class="card h-100 border-0 shadow-sm p-3">
                <div class="card-body">
                    ...
                    <h3 class="h5 fw-bold">Community Reale</h3>
                    <p class="text-muted">
...
<section id="storia" class="bg-white py-5">
    <div class="container"> <div class="row justify-content-center"> <div class="col-lg-8 text-center">
                ...
                <p class="text-secondary lead"> UniBoSpotted nasce nei laboratori di Informatica da un'idea semplice: 
                ...
                <div class="alert alert-light border mt-4 d-inline-block text-start" role="alert">
                    <h5 class="alert-heading h6 fw-bold">
                        <i class="bi bi-info-circle me-2"></i>Nota Importante
                    </h5>
                    <p class="mb-0 small">
