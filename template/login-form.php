<div class="card shadow-sm border-0 rounded-3">
    <div class="card-body p-4">
        ...
        <div class="text-center mb-4">
            <div class="mb-3">
                <i class="bi bi-person-circle display-4 text-unibo"></i>
            </div>
        ...
        <?php if(isset($templateParams["formmsg"])): ?>
            <div class="alert alert-success d-flex align-items-center p-2" role="alert">
                ...
                <div class="small">
                    <?php echo urldecode($templateParams["formmsg"]); ?>
                </div>
            </div>
        <?php endif; ?>
        ...
        <div class="text-center mt-4 pt-3 border-top">
            ...
            <a href="registration.php" class="text-decoration-none fw-bold action-unibo ms-1">
                Registrati
            </a>
        </div>
